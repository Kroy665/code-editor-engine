 ...
 * 
 * @version 1.0.0
 * @author Code Editor Engine Team
 * @license MIT
 */
...
export function selection(
  ...
  const isReversed = activeLine < anchorLine || 
    (activeLine === anchorLine && activeColumn < anchorColumn);
...
export class LanguageServiceError extends EditorError {
  constructor(message: string, public readonly languageId?: string) {
