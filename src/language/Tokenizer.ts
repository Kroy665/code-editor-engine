...
export class Tokenizer {
  ...
  private tokenizeWithLanguage(
    ...
    for (let lineIndex = 0; lineIndex < lines.length; lineIndex++) {
      ...
      const lineTokens = this.tokenizeLine(
        lineText,
        language,
        currentState,
        line,
  ...
  private resolveTokenType(text: string, baseType: TokenType, language: LanguageDefinition): TokenType {
  ...
  private getTokenModifiers(text: string, type: TokenType, _language: LanguageDefinition): string[] {
  ...
  static javascript(): LanguageDefinition {
    return {
      ...
      builtins: [
        ...
        'Number', 'Boolean', 'Function', 'RegExp', 'Date', 'Math',
  ...
  static typescript(): LanguageDefinition {
    ...
    return {
      ...
      keywords: [
        ...
        'readonly', 'static', 'as', 'is', 'keyof', 'unique',
